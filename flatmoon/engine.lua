...
function Coms:get(comclass)
    assert(type(comclass) == 'table', 'coms:remove expects coponent (table) for 1st arg')
    if comclass.__id then return self.list[comclass.__id]
    else return nil end
end
